  ...
  return (
    <div className='bg-gradient-to-b from-slate-900 to-slate-700 h-screen overflow-hidden'>
      ...
      <div className='flex flex-row items-center justify-center animate-infinite-scroll hover:animate-none'>
        <p className="text-white text-2xl font-bold my-4 whitespace-nowrap overflow-hiddens border-b-2 border-t-2"> ¡Accede ya para poder ver todas tus películas y series favoritas! ¡Accede ya para poder ver todas tus películas y series favoritas! ¡Accede ya para poder ver todas tus películas y series favoritas! ¡Accede ya para poder ver todas tus películas y series favoritas! ¡Accede ya para poder ver todas tus películas y series favoritas! ¡Accede ya para poder ver todas tus películas y series favoritas! ¡Accede ya para poder ver todas tus películas y series favoritas!</p>
